                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror" disabled>
                                    ...
                                    <option value="{{ $row->id }}" {{ old('kategori_id', $show->kategori_id) == $row->id ? 'slected' : '' }}>
                                        {{ $row->nama_kategori }}
                                    </option>
                                    @endforeach
                                </slect>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_produk" value="{{ old('nama_produk', $show->nama_produk) }}" class="form-control @error('nama_produk') is-invalid @enderror" placeholder="Masukan Nama Produk" disabled>
                                @error('nama_produk')
                                <span class="invalid-feedback alert-danger" role="alert">
                                    {{ $message }}
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <div id="foto-container">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <img scr="{{ asset('storage/img-produk/' . $gambar->foto) }}" width="100%">
                                        </div>
                                        <div class="col-mc-4">
